...
* Update linux-appimage-release to copy instead of move ZEON.AppImage.
...
* Add quick setting, organize settings, fix reconnect bug, remove profile tab in mobile, use zeonnextx forfetch profile in xray mode, update flutter.
...
* Added 'ZEON Dev Windows Portable' config to launch.json for easier testing and development of the Windows Portable version.
...
- Rewrote AppImage packaging:
  ...
  - Implements a self-contained portable data structure:
    - Creates `zeon.appimage.home` directory alongside the AppImage.
...
* Update deb configuration in make_config.yaml - Add comments for supported_mime_type parameter - Add user data cleanup script to postuninstall_scripts - Update postinstall_scripts to set StartupWMClass to app.zeonvpn.com and remove conflicting zeon.desktop from .local.
...
* Update exe configuration in make_config.yaml - Update publisher_url from zeon-next to zeon-app - Fix app_icon.ico path - Complete list of setup locales - Remove redundant 'executable_name' and 'output_base_file_name' parameters.
...
* Merge branch 'new-design-v2' of ssh://github.com/zeon/zeon-next-ios into new-design-v2.
...
* Merge branch 'fix/reported-issues' of https://github.com/veto9292/zeon-next-ios into fix/reported-issues.
...
* Merge branch 'new-design-v2' of https://github.com/zeon/zeon-next-ios into new-design-v2.
...
<a href="https://next.ossinsight.io/widgets/official/analyze-repo-stars-history?repo_id=643504282" target="_blank" style="display: block" align="center">
  <picture>
    ...
    <img alt="Star History of zeon/zeon-app" src="https://next.ossinsight.io/widgets/official/analyze-repo-stars-history/thumbnail.png?repo_id=643504282&image_size=auto&color_scheme=light" width="721" height="auto">
  </picture>
</a>
...
* Merge branch 'main' of https://github.com/zeon/zeon-next.

* Change name to zeonpackettunnel.
...
* Merge branch 'main' of zeon-github:zeon/zeon-next.
...
* Merge branch 'main' of https://github.com/nidghogg/zeon-next.
...
* Merge branch 'zeon:main' into main.
...
* Add zeoncli and resolve all false positve from anti virus, auto exit during installation.
...
* Logo, add name for zeon warp sub.
...
* Merge pull request #647 from zeon/ios.
  _Ios_
...
* Merge pull request #577 from Aryangh1379/ZEON-develop.

* Merge pull request #572 from Aryangh1379/ZEON-develop.
  _ZEON develop_
...
* Merge pull request #556 from Aryangh1379/ZEON-develop.
...
* Change the name of tunnel service to ZEONService.
...
* Merge branch 'main' of https://github.com/amirsaam/zeon-next.
...
* Remove zeon://import/ from export option.
...
* Update Tutorial_For_ZEON_Linux.desktop.

* Update Tutorial_For_ZEON.url.
...
* Change windows-portable name to ZEON-portable.
