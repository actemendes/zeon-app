...
class OutboundInfo extends $pb.GeneratedMessage {
  factory OutboundInfo({
    ...
    if (autoAllowed != null) {
      $result.autoAllowed = autoAllowed;
    }
    if (lastError != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutboundInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'hcore'), createEmptyInstance: create)
    ...
    ..a<$core.int>(18, _omitFieldNames ? '' : 'qualityScore', $pb.PbFieldType.O3)
    ..aOS(19, _omitFieldNames ? '' : 'qualityLevel')
  ...
  @$pb.TagNumber(3)
  set urlTestTime($0.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(18)
  $core.int get qualityScore => $_getIZ(17);
  @$pb.TagNumber(18)
  set qualityScore($core.int v) { $_setSignedInt32(17, v); }
  @$pb.TagNumber(18)
  $core.bool hasQualityScore() => $_has(17);
  @$pb.TagNumber(18)
  void clearQualityScore() => clearField(18);

  @$pb.TagNumber(19)
  $core.String get qualityLevel => $_getSZ(18);
  @$pb.TagNumber(19)
  set qualityLevel($core.String v) { $_setString(18, v); }
  @$pb.TagNumber(19)
  $core.bool hasQualityLevel() => $_has(18);
  @$pb.TagNumber(19)
  void clearQualityLevel() => clearField(19);

  @$pb.TagNumber(20)
  $core.bool get autoAllowed => $_getBF(19);
  @$pb.TagNumber(20)
  set autoAllowed($core.bool v) { $_setBool(19, v); }
  @$pb.TagNumber(20)
  $core.bool hasAutoAllowed() => $_has(19);
  @$pb.TagNumber(20)
  void clearAutoAllowed() => clearField(20);

  @$pb.TagNumber(21)
  $core.String get lastError => $_getSZ(20);
  @$pb.TagNumber(21)
  set lastError($core.String v) { $_setString(20, v); }
  @$pb.TagNumber(21)
  $core.bool hasLastError() => $_has(20);
  @$pb.TagNumber(21)
  void clearLastError() => clearField(21);

  @$pb.TagNumber(22)
  $fixnum.Int64 get checkedAt => $_getI64(21);
  @$pb.TagNumber(22)
  set checkedAt($fixnum.Int64 v) { $_setInt64(21, v); }
  @$pb.TagNumber(22)
