...
Assert-True -Condition $runtimeRunner.Contains("@('preflight', 'connect', 's02', 's06', 'manual-proxy', 'auto-proxy', 'p03-r17')") -Message "Remote runner must enable the bounded acceptance scenario set"
