...
ZEON App یک کلاینت پروکسی چندپلتفرمی است که توسط تیم ZEON توسعه و نگهداری می‌شود. ما محصول، انتشارها، یکپارچه‌سازی‌ها، پشتیبانی و تجربه کاربری خودمان را توسعه می‌دهیم و از ZEON به عنوان یکی از پایه‌های فنی پروژه ZEON استفاده کرده‌ایم.
...
ZEON App بر پایه ZEON ساخته شده است و از مشارکت‌کنندگان ZEON بابت کارشان قدردانی می‌کنیم. همچنین از اکوسیستم open-source که این پروژه بر آن تکیه دارد سپاسگزاریم:
