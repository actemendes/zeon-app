...
> **Статус: HISTORICAL.** Сохранённый отчёт/план прежней реализации. Не задаёт текущие задачи, тестовые критерии или доказательство готовности. Команды и ссылки относятся к исходному периоду; часть evidence может отсутствовать. [Навигация и действующие документы](../../../README.md).
...
- Существующие материалы для изучения перед работой:
  - `docs/build/APPLE_BUILD.md`
  - `docs/archive/audits/NETWORK_VPN_FINAL_AUDIT_2026-05-19.md`
  - `docs/reference/app_update_flow_current.md`
  - `docs/reference/mobile_startup_flow.md`
...
- [x] Изучить текущий update flow: `docs/reference/app_update_flow_current.md`.
...
Changed files:
- `docs/archive/plans/apple-mac-ios-release/TODO.md`
