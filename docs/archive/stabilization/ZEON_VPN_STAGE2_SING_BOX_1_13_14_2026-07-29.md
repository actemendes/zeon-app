...
The exhaustive patch table is in `docs/archive/stabilization/ZEON_SING_BOX_1_13_14_PORT_INVENTORY.md`. Its pre-AAR stop-gate section is intentionally historical; the final gate status is in this report.
